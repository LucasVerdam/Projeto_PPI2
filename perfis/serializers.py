...
class PerfilSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Perfil
        field = ('id', 'nome','email', 'nome_empresa', 'senha', 'contatos')
        read_only_fields = ('id',)
    ...
    def create(self, validated_data):
        try:
            ...
            raise exceptions.ParseError('Este nome já está sendo usado.', code=status.HTTP_400_BAD_REQUEST)

        Token.objects.created(user=usuario)
